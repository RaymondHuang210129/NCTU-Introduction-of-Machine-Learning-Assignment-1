...
vector<double> Test_tree(vector<iris> &test_data, struct node* root)  //算出accuracy, precision, recall的平均
{
	string result[30][2];
	int correct = 0;
	for (int i = 0; i < 30; i++)
	...
	for (int i = 0; i < 30; i++)
	{
		for (int j = 0; j < 3; j++)
		{
			...
			{
			case 0:
				if (result[i][0] == "Iris-setosa" && result[i][1] == "Iris-setosa")
				{
					TP[j]++;
				}
				else if (result[i][0] == "Iris-setosa" && result[i][1] != "Iris-setosa")
				{
					FP[j]++;
				}
				else if (result[i][0] != "Iris-setosa" && result[i][1] == "Iris-setosa")
				...
				break;
			case 1:
				if (result[i][0] == "Iris-versicolor" && result[i][1] == "Iris-versicolor")
				{
					TP[j]++;
				}
				else if (result[i][0] == "Iris-versicolor" && result[i][1] != "Iris-versicolor")
				{
					FP[j]++;
				}
				else if (result[i][0] != "Iris-versicolor" && result[i][1] == "Iris-versicolor")
				...
				break;
			case 2:
				if (result[i][0] == "Iris-virginica" && result[i][1] == "Iris-virginica")
				{
					TP[j]++;
				}
				else if (result[i][0] == "Iris-virginica" && result[i][1] != "Iris-virginica")
				{
					FP[j]++;
				}
				else if (result[i][0] != "Iris-virginica" && result[i][1] == "Iris-virginica")
	...
	double setosa_precision = TP[0] + FP[0] > 0 ? TP[0] / (double)(TP[0] + FP[0]) : 0; ////////////////////////todo: nan(ind)
